...
@media(min-width:769px){.main{margin-left:76px;max-width:calc(1400px + 76px)}}
...
.sb-divider{width:32px;height:1px;background:var(--border);margin:2px 0;flex-shrink:0}
...
const CFG_MAP=[
 ...
 {a:0x86,n:'Aux Input 1 Delay',u:'s',s:10,g:'Aux I/O'},
 {a:0x87,n:'Aux Input 2 Function',u:'',s:1,g:'Aux I/O'},
...
function relabelIO(d){
 ...
 ioMap.forEach(m=>{
  ...
  if(el)el.textContent=lbl!=null?lbl:'Function '+v;
 });
}
